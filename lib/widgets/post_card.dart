...
import 'pinch_zoom.dart'; // <-- Add this import (adjust path if necessary)
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Double tap for like still wraps the whole media container
        GestureDetector(
          ...
          child: AspectRatio(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                // Wrap the image with the InstagramPinchZoom widget
                return InstagramPinchZoom(
